...
import numpy as np
from ..selection.AbsSelectStrategy import AbsSelectStrategy
from ..steps.Steps import *
from ..steps.ClusterTestStep import *
from ..steps.PatternFitnessStep import *
import pandas as pd
...
class PrioritySelectStrategy(AbsSelectStrategy):
    def __init__(self):
        self.ats_utils = Steps()
        self.cluster_test_step = ClusterTestStep()
        self.pattern_fitness_step = PatternFitnessStep()
