    ...
    for epoch_id in range(args.num_epochs):
        ...
        for batch_id in range(batches_per_epoch):
            ...
            if (batch_id + 1) % log_every == 0:
                print('[Epoch {}/{} Batch {}/{}] Loss={:.5f}.'.format(epoch_id + 1, args.num_epochs, batch_id + 1,
                                                                      batches_per_epoch, loss))

        if (epoch_id + 1) % save_every == 0:
            f_online.save('f_online_{}.h5'.format(epoch_id + 1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder', type=str, required=True, choices=['resnet18', 'resnet34'],
