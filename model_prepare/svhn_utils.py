...
train_path = 'datasets/svhn/train_32x32.mat'
test_path = 'datasets/svhn/test_32x32.mat'
extra_path = 'datasets/svhn/extra_32x32.mat'
...
def format_data_2(raw_data, number_of_examples):
    """
    Reshape RAW data to regular shape
    """
    old_shape = raw_data.shape
...
def my_load_svhn_data_before_processing(train_path, test_path, extra_path, load_extra):
    """
    Load SVHN Dataset
    """
    print("Loading SVHN dataset for classification...")
    ...
    # get values and labels
    train_all_values = format_data_2(train['X'], train['X'].shape[3])
    train_all_labels = one_hot_encoder(train['y'], 10)
    test_values = format_data_2(test['X'], test['X'].shape[3])
    test_labels = one_hot_encoder(test['y'], 10)
...
def load_data_before_processing():
    train_X, train_Y, test_X, test_Y = my_load_svhn_data_before_processing(train_path = train_path,
                                                                      test_path = test_path,
...
if __name__ == "__main__":
    ...
    #                                                                   eval_percentage = 0.1
    #                                                                  )
    (train_X, train_Y), (test_X, test_Y) = load_data_before_processing()
